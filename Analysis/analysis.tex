...
\begin{itemize}
  ...
  \item Queing Delay
  \item Transmission Delay: The amount of time it takes for a node to 'push' packets (bit by bit) onto the line \citep{chen2005}. %this reference doesn't seem to work properly. Need to fix. 
