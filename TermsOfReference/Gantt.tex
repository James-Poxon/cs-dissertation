...
\ganttmilestone[ms=left]{Explain Virtualisation}{10/11/20}
\ganttmilestone[ms=right]{Explain Containerisation}{25/11/20}\\
\ganttmilestone[ms=right]{Revise Analysis}{4/12/20}\\
...
\ganttbar{}{14/12/20}{1/1/21}\\
\ganttmilestone[ms=left]{Determine Benchmarks}{20/12/20}\\
