...
\ganttbar[inline]{\emph{Virtualisation}}{10/11/20}{20/11/20}\\  %Not sure if these can be made to sit on one line whilst still being comprehensible.
\ganttbar[inline]{\emph{Containerisation}}{20/11/20}{30/11/20}\\
...
\ganttbar{Design}{31/10/20}{1/1/21}
\ganttbar[inline]{\emph{Hardware}} {31/10/20}{15/11/20}
\ganttbar[inline]{\emph{Software}} {15/11/20}{1/12/20}
\ganttbar[inline]{\emph{Benchmark design}} {2/12/20}{1/1/21}\\
\ganttmilestone[ms=left]{Determine benchmarks (Obj \ref{itm:determinemethod})}{29/12/20}\\


%Learning
\ganttbar{Learning}{10/11/20}{10/12/20}
\ganttbar[inline]{\emph{Learn Docker}}{10/11/20}{10/12/20}
\ganttbar[inline]{\emph{Troubleshooting}}{1/2/21}{8/3/21}\\
...
\ganttbar[inline]{\emph{Build VMs}}{18/1/21}{1/2/21}
\ganttbar[inline]{\emph{Build Containers}}{1/2/21}{30/2/21}
\ganttbar[inline]{\emph{Benchmarking}}{2/3/21}{18/3/21}\\
...
%Evaluation
\ganttbar{Evaluation}{30/02/21}{8/04/21}
\ganttbar[inline]{\emph{Evaluate}}{2/3/21}{18/3/21}
\ganttbar[inline]{\emph{Comparisons}}{18/3/21}{8/04/21}\\
\ganttmilestone[ms=right]{Make comparisons (Obj \ref{itm:comparison})}{25/3/21}\\

%Conclusion
\ganttbar{Conclusion}{15/03/21}{17/04/21}
\ganttbar[inline]{\emph{Conclusions}}{15/03/21}{1/04/21}
\ganttbar[inline]{\emph{Introduction}}{1/04/21}{17/04/21}\\
